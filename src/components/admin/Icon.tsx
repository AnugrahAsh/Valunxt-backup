/**
 * The admin panel's line icons, in one place.
 *
 * The same 24px stroke set the PHP screens inlined (Feather geometry), keyed by
 * name so a screen writes <Icon name="mail" /> instead of repeating the SVG.
